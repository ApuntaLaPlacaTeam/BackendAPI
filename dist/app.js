...
const api_hack_1 = require("./controllers/api_hack");
// API keys and Passport configuration
const passportConfig = __importStar(require("./config/passport"));
// Instance Api Hackathon
const apiHackathon = new api_hack_1.APIHackathon();
...
app.get("/api/tipos-de-infracciones", express_async_handler_1.default(apiHackathon.getTiposDeInfracciones));
app.get("/api/infracciones-x-ubicacion", express_async_handler_1.default(apiHackathon.getInfraccionesXUbicacion));
app.get("/api/infracciones", express_async_handler_1.default(apiHackathon.getInfracciones));
app.post("/api/guardar-infraccion", express_async_handler_1.default(apiHackathon.postGuardarInfraccion));
/**
